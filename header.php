...
<nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
  <a class="navbar-brand mb-0 h1" href="#">Bakery</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="expense.php">Purchase Orders<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="supply.php">Suppliers</a>
      </li>
      <li class="nav-item">
